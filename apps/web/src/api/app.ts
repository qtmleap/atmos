...
//
//   export const xxxRoutes = new Hono<{ Bindings: CloudflareBindings }>()
//
// and are mounted onto `api` below with `api.route('/<prefix>', xxxRoutes)`,
...
// everything else is served from the static assets. wrangler.toml
