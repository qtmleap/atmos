...
import { type Db, type JobRow, jobs, type LogRow, logs, type ProjectRow, projects } from '#schema'
 ...
 * into chunks of this size and sent together with `platform.batch`, which is
