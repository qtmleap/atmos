...
/**
 * The menu's look, shared with the static specimens in /catalog, which show
 * an opened menu in the page flow where Radix would portal and position it.
 * Item highlight follows Radix's data-highlighted.
 */
const dropdownMenuStyles = {
  content: 'min-w-48 rounded-md border bg-popover p-1 text-popover-foreground',
  item: "relative flex w-full cursor-default items-center gap-2 rounded-sm px-2 py-1.5 text-left text-sm outline-hidden select-none focus-visible:ring-[3px] focus-visible:ring-ring/50 data-[disabled]:pointer-events-none data-[disabled]:opacity-50 data-[highlighted]:bg-accent data-[highlighted]:text-accent-foreground data-[inset]:pl-8 data-[variant=destructive]:text-destructive data-[variant=destructive]:data-[highlighted]:bg-destructive/10 data-[variant=destructive]:data-[highlighted]:text-destructive dark:data-[variant=destructive]:data-[highlighted]:bg-destructive/20 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
...
function DropdownMenuLabel({
  ...
  return (
    <DropdownMenuPrimitive.Label
      ...
      data-inset={inset}
      className={cn(dropdownMenuStyles.label, 'data-[inset]:pl-8', className)}
      {...props}
    />
  )
}
